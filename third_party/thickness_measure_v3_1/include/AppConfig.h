...
struct OnnxToeLocatorConfig
{
    ...
    std::string inputRawName;
    std::string inputSmoothName;
    ...
    OnnxToeLocatorConfig()
        : enabled(true),
          modelPath("E:\\Deep_Learning\\PointNet_Test\\pointnet_weld_seam.onnx"),
          inputRawName("input_raw"),
          inputSmoothName("input_smooth"),
          outputName("output_segmentation"),
          targetPointCount(256),
