    ...
    std::printf("\n==== thickness V2 pairs ====\n");
    {
        const QString thicknessIni =
            QDir(QCoreApplication::applicationDirPath())
                .filePath(QStringLiteral("config/thickness_measure_v3_2/thickness_measurement.ini"));
        const QString outerTemplatePath =
            QDir(QCoreApplication::applicationDirPath())
                .filePath(QStringLiteral(
                    "config/thickness_measure_v3_2/Data/Template_Path4_Arm_cloud_stitched_1_sample.pcd"));
