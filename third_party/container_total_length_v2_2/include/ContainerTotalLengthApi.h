#ifndef CONTAINER_TOTAL_LENGTH_V2_2_API_H_
#define CONTAINER_TOTAL_LENGTH_V2_2_API_H_
...
CONTAINER_TOTAL_LENGTH_API ctl_status ctl_create_from_ini(
    const char* config_path, ctl_context** out_context,
    char* message, size_t message_size);

CONTAINER_TOTAL_LENGTH_API ctl_status ctl_measure(
    ctl_context* context, const float* xyz, size_t point_count,
    ctl_result* result, char* message, size_t message_size);
